...
import Vue from 'vue';
import { SidebarMinimizer, SidebarToggler, HeaderDropdown } from '@coreui/vue';
import { 
...
Vue.component('sidebar-minimizer', SidebarMinimizer);
Vue.component('app-header-dropdown', HeaderDropdown);
...
// custom component
Vue.component('list-grid', () => import( /* webpackChunkName: "list-grid" */ './components/common/ListGrid.vue'));
